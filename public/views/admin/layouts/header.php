...
<head>
    ...
    <link href="http://localhost/public/views/admin/css/styles.css" rel="stylesheet" />
    <link href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" rel="stylesheet" crossorigin="anonymous" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/js/all.min.js" crossorigin="anonymous"></script>
    <script src="http://localhost/public/views/admin/ckeditor/ckeditor.js"></script>
</head>

<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index"><?= $setting["title"] ?></a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="btn btn-block btn-success" href="http://localhost">
                            View Website
                        </a>
                        <a class="btn btn-block btn-success " href="settings">
                            website setting
                        </a>
                        <a class="btn btn-block btn-danger" href="http://localhost/auth/logout">
                            Log Out Account
                        </a>
